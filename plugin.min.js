	...
	tinymce.create('tinymce.plugins.ResponsiveFileManager', 
	{
		...
		init : function(editor, url)
		{
			...
			function openmanager() 
			{
				...
				//ADDED the fldr and folder setting to ensure it's set for uploads and browsing currectly.
				win = editor.windowManager.open({
					title: title,
					file: url+'/filemanager/dialog.php?type=4&descending='+descending+sort_by+fldr+crossdomain+'&lang='+editor.settings.language+'&folder='+editor.settings.image_folder+'&fldr='+editor.settings.image_folder,
					width: 860,
					height: 570,
					inline: 1,
					resizable: true,
			...
			function filemanager (id, value, type, win) {
				...
				tinymce.activeEditor.windowManager.open({
					title: title,
					file: url+'/filemanager/dialog.php?type='+urltype+'&descending='+descending+sort_by+fldr+crossdomain+'&lang='+editor.settings.language+'&folder='+editor.settings.image_folder+'&fldr='+editor.settings.image_folder,
					width: 860,  
					height: 570,
					resizable: true,
					maximizable: true,
