...
/** 
ADDED BY DXGCMS
$folder sets the root folder for uploads, images, etc
**/
global $folder;
$folder = urldecode(trim(strip_tags($_GET["folder"])));
...
/** 
ADDED BY DXGCMS
$cur_dir is overwritten to make sure of nothing is messed up.
**/
...
/** 
ADDED BY DXGCMS
fldr is now $_GET["fldr"], same for folder same concept 
To make sure the home directory is not touch or they cant browse the server.
**/
...
<html xmlns="https://www.w3.org/1999/xhtml">
	...
	/** 
	ADDED BY DXGCMS
	Base URL was removed to ensure of no conflicts
	**/
	?>
...
<!-- header div end -->
	...
	?>
	<ul class="breadcrumb">	
	<li class="pull-left"><a href="/"><i class="icon-home"></i></a></li>
	...
	?> <li class="active"><?php echo $b?></li><?php
		...
		<li><?php echo $b?></li><li><span class="divider"><?php echo "/"; ?></span></li>
	<?php }
	}
	?>
	...
	<div class="span12">	    
		...
		foreach ($files as $file_array) {
			...
			?>
			    ...
			    ?>	<figure style="display:none;" data-name="<?php echo $file ?>" class="<?php if($file=="..") echo "back-"; ?>directory" data-type="<?php if($file!=".."){ echo "dir"; } ?>">
